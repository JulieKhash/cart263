...
let $firstImage = $(`body`).append(
  `<img id="background" src="assets/images/testman.png">`
);

let $text1 = `Do you see the end?`;

let $secondImage = `<img id="background" src="assets/images/testman.png">`;
let $thirdImage = `<img id="smoke-img" src="assets/images/smoke.png">`;

let $ghostImg = `<img class="crystal-img" id="ghost" src="assets/images/sun2.png">`;

// appends text
let $text = $(`#drop-text`).append(`drag and drop onto the circle`);
